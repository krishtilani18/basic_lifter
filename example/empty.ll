...
define ptr @sub_1129(ptr noalias %state, i64 %program_counter, ptr noalias %memory) {
...
define ptr @sub_1040(ptr noalias %state, i64 %program_counter, ptr noalias %memory) {
